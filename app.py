...
def pre_process_data(dataset,oh_map, sc):
    ...
    dataset.columns = ['Var1', 'Online_Follower', 'LinkedIn_Shared', 'Twitter_Shared',
       'Facebook_Shared', 'Donation', 'Camp_Duration', 'dur_rf',
       'RD', 'RM', 'RY', 'RW', 'CSD', 'CSM', 'CSY', 'CSW', 'CED', 'CEM', 'CEY',
       'CEW', 'FID', 'FIM', 'FIY', 'FIW', 'Category1_Second',
       'Category1_Third', 'Category2_B', 'Category2_C', 'Category2_D',
       'Category2_E', 'Category2_F', 'Category2_G', 'Category3_2']
